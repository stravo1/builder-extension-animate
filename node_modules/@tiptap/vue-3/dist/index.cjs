...
// src/utils/undeclaredWidgetProps.ts
...
function collectPropNames(component, names) {
  ...
  (_a = options.mixins) == null ? void 0 : _a.forEach((mixin) => collectPropNames(mixin, names));
  collectPropNames(options.extends, names);
  const { props } = options;
  if (Array.isArray(props)) {
    props.forEach((name) => names.add((0, import_vue9.camelize)(name)));
  } else if (props) {
    Object.keys(props).forEach((name) => names.add((0, import_vue9.camelize)(name)));
  }
}
function undeclaredWidgetProps(component, props) {
  ...
  for (const name of ["editor", "getPos", ...Object.keys(props)]) {
    if (!declared.has((0, import_vue9.camelize)(name))) {
...
// src/utils/wrapFunctionalWidget.ts
...
function wrapFunctionalWidget(component, props) {
  ...
  wrapped.displayName = (_a = component.displayName) != null ? _a : component.name;
  return wrapped;
}

// src/VueWidgetRenderer.ts
var WIDGET_CACHE = /* @__PURE__ */ Symbol("tiptapVueWidgetCache");
function VueWidgetRenderer(component, options) {
  ...
  return (0, import_core4.createWidgetDecoration)({
    ...
    context: (getPos) => ({ editor: (0, import_vue10.markRaw)(editor), getPos }),
...
function buildOptionsWidget(component, props) {
  return (0, import_vue10.defineComponent)({
    extends: { ...component },
    ...
    setup: (reactiveProps, context) => {
      var _a;
      return (_a = component.setup) == null ? void 0 : _a.call(component, reactiveProps, context);
    },
    __scopeId: component.__scopeId,
    __cssModules: component.__cssModules,
    __name: component.__name,
