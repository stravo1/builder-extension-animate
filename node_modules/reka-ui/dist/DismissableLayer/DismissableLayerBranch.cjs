...
var DismissableLayerBranch_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ (0, vue.defineComponent)({
	...
	setup(__props) {
		...
		(0, vue.onMounted)(() => {
			require_DismissableLayer_context.context.branches.add(currentElement.value);
		});
		(0, vue.onUnmounted)(() => {
			require_DismissableLayer_context.context.branches.delete(currentElement.value);
		});
		return (_ctx, _cache) => {
